...
public class PolygonGenerator extends GeometryGenerator {
   ...
   *
   * @throws IllegalStateException When the alg is not valid or the number of
   * points is invalid
   * @throws NullPointerException when either the Geometry Factory, or the
   * Bounding Box are undefined.
   * @see #getNumberPoints()
